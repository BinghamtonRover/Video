...
class LidarBinding {
  ...
  int SickScanApiLoadLibrary(
    ffi.Pointer<pkg_ffi.Utf8> library_filepath,
  ) {
  ...
  late final _SickScanApiLoadLibraryPtr = _lookup<
  ...
  SickScanApiHandle SickScanApiCreate(
    int argc,
    ffi.Pointer<ffi.Pointer<pkg_ffi.Utf8>> argv,
  ) {
  ...
  late final _SickScanApiCreatePtr = _lookup<
      ffi.NativeFunction<
          SickScanApiHandle Function(ffi.Int,
              ffi.Pointer<ffi.Pointer<pkg_ffi.Utf8>>)>>('SickScanApiCreate');
  late final _SickScanApiCreate = _SickScanApiCreatePtr.asFunction<
      SickScanApiHandle Function(
          int, ffi.Pointer<ffi.Pointer<pkg_ffi.Utf8>>)>();
  ...
  int SickScanApiInitByLaunchfile(
    SickScanApiHandle apiHandle,
    ffi.Pointer<pkg_ffi.Utf8> launchfile_args,
  ) {
  ...
  late final _SickScanApiInitByLaunchfilePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(SickScanApiHandle,
              ffi.Pointer<pkg_ffi.Utf8>)>>('SickScanApiInitByLaunchfile');
  late final _SickScanApiInitByLaunchfile = _SickScanApiInitByLaunchfilePtr
      .asFunction<int Function(SickScanApiHandle, ffi.Pointer<pkg_ffi.Utf8>)>();
  ...
  late final _SickScanApiInitByCliPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(SickScanApiHandle, ffi.Int,
              ffi.Pointer<ffi.Pointer<pkg_ffi.Utf8>>)>>('SickScanApiInitByCli');
  late final _SickScanApiInitByCli = _SickScanApiInitByCliPtr.asFunction<
      int Function(
          SickScanApiHandle, int, ffi.Pointer<ffi.Pointer<pkg_ffi.Utf8>>)>();
  ...
  int SickScanApiGetStatus(
    ...
    ffi.Pointer<pkg_ffi.Utf8> message_buffer,
  ...
  int SickScanApiSendSOPAS(
    SickScanApiHandle apiHandle,
    ffi.Pointer<pkg_ffi.Utf8> sopas_command,
    ffi.Pointer<pkg_ffi.Utf8> sopas_response_buffer,
  ...
  late final _SickScanApiSendSOPASPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(SickScanApiHandle, ffi.Pointer<pkg_ffi.Utf8>,
              ffi.Pointer<pkg_ffi.Utf8>, ffi.Int32)>>('SickScanApiSendSOPAS');
  late final _SickScanApiSendSOPAS = _SickScanApiSendSOPASPtr.asFunction<
      int Function(SickScanApiHandle, ffi.Pointer<pkg_ffi.Utf8>,
          ffi.Pointer<pkg_ffi.Utf8>, int)>();
...
final class SickScanHeaderType extends ffi.Struct {
  ...
  @ffi.Array.multi([256])
  external ffi.Array<pkg_ffi.Utf8> frame_id;
}
...
final class SickScanPointFieldMsgType extends ffi.Struct {
  ...
  @ffi.Array.multi([256])
  external ffi.Array<pkg_ffi.Utf8> name;
...
final class SickScanPointCloudMsgType extends ffi.Struct {
  ...
  @ffi.Array.multi([256])
  external ffi.Array<pkg_ffi.Utf8> topic;
}
...
final class SickScanVisualizationMarkerType extends ffi.Struct {
  ...
  external ffi.Array<pkg_ffi.Utf8> ns;
  ...
  @ffi.Array.multi([1024])
  external ffi.Array<pkg_ffi.Utf8> text;

  /// NOTE: only used for MESH_RESOURCE markers
  @ffi.Array.multi([1024])
  external ffi.Array<pkg_ffi.Utf8> mesh_resource;
...
final class SickScanLogMsgType extends ffi.Struct {
  ...
  /// log message
  external ffi.Pointer<pkg_ffi.Utf8> log_message;
}
...
final class SickScanDiagnosticMsgType extends ffi.Struct {
  ...
  /// diagnostic message
  external ffi.Pointer<pkg_ffi.Utf8> status_message;
}
